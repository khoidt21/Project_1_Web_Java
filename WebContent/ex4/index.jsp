   <%@page import="com.org.java.NumberEx4"%>
				            ...
				            <div class="block-18">
				              <div class="text d-flex">
				              	...
				              	<div class="desc text-left">
				              		<% NumberEx4 numCountries = new NumberEx4();
				              			%>
				              				<strong class="number" data-number="<%=numCountries.countries(46) %>">0</strong>
				              				<span><%=numCountries.title("Countries") %></span>
				              			<%	
				              		%>
				                </div>
				              </div>
				          ...
				          <div class="col-md-4 d-flex justify-content-center counter-wrap ftco-animate">
				            <div class="block-18 text-center">
				              <div class="text d-flex">
				              	...
				              	<div class="desc text-left">
				              	<% NumberEx4 numCompanies = new NumberEx4();
				              		%>
				              			<strong class="number" data-number="<%=numCompanies.companies(450) %>">0</strong>
				              			<span><%=numCompanies.title("Companies") %></span>
				              		<% 
				              	%>	
				          ...
				          <div class="col-md-4 d-flex justify-content-center counter-wrap ftco-animate">
				            <div class="block-18 text-center">
				              <div class="text d-flex">
				              	...
				              	<div class="desc text-left">
				              	<%
				              		NumberEx4 employees = new NumberEx4();
				              		%><strong class="number" data-number="<%=employees.employess(80000) %>">0</strong>
				              			<span><%=employees.title("Active Employees") %></span>
				              		<%
				              	%>
					              </div>
				              </div>
